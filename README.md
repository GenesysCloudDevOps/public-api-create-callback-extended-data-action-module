A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Create Callback Extended
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-create-callback-extended-data-action-module.git?ref=v1.0.0"
    action_name        = "Create Callback Extended"
